                            ...
                            <tbody>
                                  ...
                                  @foreach ($banner as $key=>$row)
                                    <tr>
                                      ...
                                      <td >
                                            <a href="{{ route('banner.edit',$row->id) }}" class="btn btn-info btn-sm" title="Edit Data"><i class="fas fa-edit"></i></a>
                                            <a href="{{ route('banner.delete',$row->id) }}" id="delete" class="btn btn-danger btn-sm delete" title="Delete Data"><i class="fas fa-trash-alt"></i></a>
                                      </td>
                                    </tr>
                                  @endforeach
