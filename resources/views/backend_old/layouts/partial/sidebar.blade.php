        ...
        <ul class="nav side-menu">
          ...
          <li><a><i class="fa fa-bank"></i> Account <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
                ...
                <li><a>Create Billing <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="{{ route('work_bill.create') }}">Create Work Bill</a></li>
                    <li><a href="{{ route('monthly_bill.create') }}">Create Monthly Bill</a></li>
                  </ul>
                </li>

                <li><a>Submit Billing <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="#">Submit Work Bill</a></li>
                    <li><a href="#">Submit Monthly Bill</a></li>
                  </ul>
                </li>
